<template>
  <div class="app-container">
    <n-tabs type="line" animated v-model:value="tabsValue" style="padding-left: .3rem;" @update:value="getList">
      <n-tab :name="MediaClassifyConstant.PROVINCE">省份</n-tab>
      <n-tab :name="MediaClassifyConstant.CITY">城市</n-tab>
    </n-tabs>
...
// 获取tabs列表
// 指定tabs默认选中项
const tabsValue = ref(MediaClassifyConstant.PROVINCE)
...
const clickFolder = (id) => {
  ...
  router.push({
    ...
    query: {
      ...
      backToPath: '/media/classify/classifyPlace'
    }
  })
}
